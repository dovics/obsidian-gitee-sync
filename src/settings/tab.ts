...
export default class GiteeSyncSettingsTab extends PluginSettingTab {
  plugin: GiteeSyncPlugin;

  constructor(app: App, plugin: GiteeSyncPlugin) {
    super(app, plugin);
    this.plugin = plugin;
  }
  ...
  display(): void {
    ...
    new Setting(containerEl)
      .setName("Gitee token")
      .setDesc(
        "A personal access token with read and write access to your repository",
      )
      .addButton((button) =>
      ...
      .addText((text) => {
        text
          ...
          .setValue(this.plugin.settings.giteeToken)
          .onChange(async (value) => {
            this.plugin.settings.giteeToken = value;
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          ...
          .setValue(this.plugin.settings.giteeOwner)
          .onChange(async (value) => {
            this.plugin.settings.giteeOwner = value;
            await this.plugin.saveSettings();
          }),
      );
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          ...
          .setValue(this.plugin.settings.giteeRepo)
          .onChange(async (value) => {
            this.plugin.settings.giteeRepo = value;
            await this.plugin.saveSettings();
          }),
      );
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          ...
          .setValue(this.plugin.settings.giteeBranch)
          .onChange(async (value) => {
            this.plugin.settings.giteeBranch = value;
            await this.plugin.saveSettings();
          }),
      );
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        ...
        when downloading from Gitee repository`,
      )
